...
\begin{frame}{Overview of Identification Strategy}
  ...
  \begin{center}
        ...
        \begin{tabular}{lV{\linewidth}}
          ...
          \hline\hline
          Common ownership weight $\symbf{K}$         & Institutional investor holdings in 13f filings
          ...
          \hline
          Technology spillover $\symbf{\Omega}$   & Technology proximity \citep{Bloom2013-pn}:
...
\begin{frame}{Common Ownership Weight}
  \begin{itemize}
    \item \citet{Backus2021-yt} construct a dataset on investors' holdings
          based on Form 13F
    \item Baseline: \cite{Rotemberg1984-jz} proportional influence assumption \hfill\hyperlink{rotemberg}{\beamerbutton{Proportional Influece}}
  \end{itemize}
  \begin{center}
...
\begin{frame}{Total Output}
  ...
  \begin{tabular}{@{} c *{5}{c} @{}} 
    \toprule
    \multirow{2}{*}{\shortstack[t]{Total output \\ (Social Optimum: 100)}} 
...
\begin{frame}{Total R\&D Expenditure}
  ...
  \begin{tabular}{@{} c *{5}{c} @{}} 
    \toprule
    \multirow{2}{*}{\shortstack[t]{Total R\&D Expenditure \\ (Social Optimum: 100)}} 
      & \multicolumn{5}{c}{Ownership (Baseline: 2017)} \\
    \cmidrule(lr){2-6}
      & Dispersed 
      & Mean$=$1999 
...
\begin{frame}{Expected Growth Rate}
  ...
  \begin{tabular}{@{} c *{5}{c} @{}} 
    \toprule
    \multirow{2}{*}{\shortstack[t]{Expected economic \\ growth rate (\%)}} 
      & \multicolumn{5}{c}{Ownership (Baseline: 2017)} \\
    \cmidrule(lr){2-6}
      & Dispersed 
      & Mean$=$1999 
...
\begin{frame}{Firm Value Share}
  ...
  \begin{tabular}{@{} c *{5}{c} @{}} 
    \toprule
    \multirow{2}{*}{\shortstack[t]{Firm value \\ share (\%)}} 
      & \multicolumn{5}{c}{Ownership (Baseline: 2017)} \\
    \cmidrule(lr){2-6}
      & Dispersed 
      & Mean$=$1999 
...
\begin{frame}{Riccati Equations}
  ...
  \label{riccati}
  \begin{itemize}
    \item $V^{i}\left(\symbf{z}\right)=\symbf{z}^{T}\symbf{X}^{i}\symbf{z}$ where
